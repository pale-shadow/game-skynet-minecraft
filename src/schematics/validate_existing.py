...
def validate_schematics(directory):
    ...
    files = [f for f in os.listdir(directory) if f.endswith('.schematic') or f.endswith('.schem')]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir', type=str, required=True, help='Directory containing schematics.')
