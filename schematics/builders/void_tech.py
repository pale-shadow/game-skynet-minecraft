...
def apply_void_palette(prompt):
    ...
    mats.update({
        ...
        "mutation": ["minecraft:magenta_carpet", "minecraft:cherry_leaves", "minecraft:sculk_vein"]
    })
...
def build_ribbed_structure(schem, x, y, z, radius, height, materials):
    ...
    for ry in range(0, height):
        ...
        for angle in range(0, 360, 10):
            ...
            if is_rib:
                schem.setBlock((bx, y + ry, bz), f"minecraft:polished_tuff_stairs[facing=north,half=top]")
            else:
