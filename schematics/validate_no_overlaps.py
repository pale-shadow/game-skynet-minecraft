...
def check_overlaps(schem_files_dir, proposed_build=None):
    ...
    for i in range(len(builds)):
        ...
        current_comparison_start = start_index_for_comparison if i == 0 and proposed_build else i + 1
        ...
        for j in range(current_comparison_start, len(builds)):
            ...
            if (b1["x1"] < b2["x2"] and b1["x2"] > b2["x1"] and
                b1["y1"] < b2["y2"] and b1["y2"] > b2["y1"] and
                b1["z1"] < b2["z2"] and b1["z2"] > b2["z1"]):
    ...
    if overlaps:
        ...
        for b1, b2 in overlaps:
            ...
            print(f"    - {b1['id']}: ({b1['x1']}, {b1['y1']}, {b1['z1']}) to ({b1['x2']}, {b1['y2']}, {b1['z2']})")
            print(f"    - {b2['id']}: ({b2['x1']}, {b2['y1']}, {b2['z1']}) to ({b2['x2']}, {b2['y2']}, {b2['z2']})")
...
if __name__ == "__main__":
    ...
    test_proposed_build = {
        ...
        "x1": -1060, "y1": 60, "z1": -530,
        "x2": -1040, "y2": 80, "z2": -510,
